...
function startFunction(){
    ...
    var main=document.getElementById("main");
        ...
        var h1=document.createElement("h1");
        h1.setAttribute("value","Title One");
        h1.appendChild(document.createTextNode("Title One"));
        info.appendChild(h1);
        ...
        var h1=document.createElement("h1");
        h1.setAttribute("value","Title One");
        h1.appendChild(document.createTextNode("Title Two"));
        info.appendChild(h1);
        var h5=document.createElement("h5");
        var graytext=document.createElement("span");
        graytext.setAttribute("class","grayText");
        ...
        option2.appendChild(document.createTextNode("Title One"));
        var option3=document.createElement("option");
        option3.appendChild(document.createTextNode("Title Two"));
